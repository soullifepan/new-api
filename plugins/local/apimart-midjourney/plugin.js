...
export const meta = {
  ...
  usageProfiles: [{
    ...
    examples: [
      ...
      { label: "Blend · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Edits · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Upscale · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Variation · Fast", facts: { documented_credits: 0.5504 } },
      { label: "High variation · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Low variation · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Reroll · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Zoom · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Pan · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Remix strong · Fast", facts: { documented_credits: 0.5504 } },
      { label: "Remix subtle · Fast", facts: { documented_credits: 0.5504 } },
