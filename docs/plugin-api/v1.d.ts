...
export type UsageFieldSchema = {type: "number"; unit: "second" | "count" | "token" | "credit" | "usd"; description?: LocalizedText} | {type: "boolean"; description?: LocalizedText} | {enum: readonly string[]; description?: LocalizedText};
